        ...
        <div class="row">
            <div class="col-sm-3 col-md-2 dashboard-sidebar">
                <ul class="nav nav-sidebar">
                    ...
                    <li class="active"><a href="<?php echo U( '/Admin/AddCreature' );?>">生物</a></li>
            ...
            <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                <h2 class="sub-header">生物</h2>
                <form class="form-horizontal" role="form"  method="post" action="<?php echo U( 'Admin/AddCreature/addCreature' );?>">
                    ...
                    <div class="form-group">
                        <label for="inputName" class="col-sm-2 col-md-1 control-label">生物名称</label>
                        <div class="col-sm-4 col-md-3">
                            <input type="text" class="form-control" id="inputName" placeholder="" name="creatureName">
                        </div>
                    </div>
                    <div class="form-group">
