        ...
        <div class="row">
            <div class="col-sm-3 col-md-2 dashboard-sidebar">
                <ul class="nav nav-sidebar">
                    ...
                    <li class="active"><a href="<?php echo U( '/Admin/AddNotification' );?>">通知</a></li>
            ...
            <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                <h2 class="sub-header">通知</h2>
                <form class="form-horizontal" role="form" method="post" action="<?php echo U( 'Admin/AddNotification/addNotification' );?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="inputTitle" placeholder="" name="notificationTitle">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="inputContent" class="col-sm-2 col-md-1 control-label">内容</label>
                        <div class="col-sm-10">
                            <textarea class="form-control" rows="10" id="inputContent" name="notificationContent"></textarea>
                        </div>
                    </div>
                    <div class="form-group">
